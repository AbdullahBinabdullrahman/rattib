...
export const DICT = {
  ...
  nafathSignIn: { ar: "المتابعة عبر نفاذ", en: "Continue with Nafath" },
  nafathNote: {
    ar: "الطريقة الموصى بها — تتحقق من هويتك مرة واحدة وتفتح التجارب المقيّدة الحضور.",
    en: "The recommended path — verifies your identity once and unlocks audience-locked experiences.",
  },
  orUse: { ar: "أو بالبريد ورقم الجوال", en: "or use email and mobile" },
  ...
  why1b: {
    ar: "كل خبير موثّق عبر نفاذ ويحمل سجلًا تجاريًا أو وثيقة عمل حر، مع رخصة النشاط المطلوبة.",
    en: "Every expert is Nafath-verified and holds a CR or freelance certificate, plus the activity licence their category requires.",
  },
  ...
  nafathVerified: { ar: "موثّق عبر نفاذ", en: "Nafath verified" },
  ...
  male: { ar: "ذكر", en: "Male" },
  verifyNafath: { ar: "التحقق عبر نفاذ", en: "Verify with Nafath" },
  verified: { ar: "موثّق", en: "Verified" },
  lockedNotice: {
    ar: "هذه تجربة مقيّدة الحضور — يجب التحقق من هوية كل ضيف عبر نفاذ.",
    en: "This experience has a locked audience — every guest must be Nafath-verified.",
  },
