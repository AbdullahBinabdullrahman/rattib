...
export const DICT = {
  ...
  locationSection: { ar: "الموقع", en: "Location" },
  byName: { ar: "بالاسم", en: "By name" },
  onMap: { ar: "على الخريطة", en: "On map" },
  byCoords: { ar: "إحداثيات", en: "Coordinates" },
  searchPlaceholder: {
    ar: "ابحث عن حي أو معلم — مثل: الدرعية، برج المملكة",
    en: "Search a district or landmark — e.g. Diriyah, Kingdom Centre",
  },
  searching: { ar: "جارٍ البحث…", en: "Searching…" },
  noPlaces: {
    ar: "لا توجد نتيجة. حدّد الموقع على الخريطة أو أدخل الإحداثيات.",
    en: "No match. Drop a pin on the map or enter coordinates instead.",
  },
  kindDistrict: { ar: "حي", en: "District" },
  kindLandmark: { ar: "معلم", en: "Landmark" },
  latField: { ar: "خط العرض", en: "Latitude" },
  lonField: { ar: "خط الطول", en: "Longitude" },
  mapPickHint: {
    ar: "اضغط على الخريطة أو اسحب العلامة",
    en: "Click the map or drag the pin",
  },
  selectedPoint: { ar: "الموقع المحدد:", en: "Selected point:" },
  outsideRiyadh: { ar: "خارج نطاق الرياض", en: "Outside Riyadh" },
